...
#'
#' @param x  callable graphical element to be added to a panel in a lattice plot 
#' @param row row identifying desired panel in multi-panel plots.  
#' @param col column identifying desired panel in multi-panel plots.  
#' 
#' 
#' @details
