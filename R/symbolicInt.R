...
symbolicInt<- function(form, ...){
  ...
  LETTERS <- c(LETTERS, paste(LETTERS,"1",sep=""), paste(LETTERS,"2",sep=""))
  ...
  # package up the name of the symbolic constant of integration for use by antiD
  assign("..NameOfSymbolicConstant",intc,envir=environment(intfun)) 
  return(intfun)
}
