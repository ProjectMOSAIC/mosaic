...
inputPanel(
  ...
  # checkboxInput("show_histogram", "Show histogram", TRUE) ,
  # checkboxInput("show_freqpolygon", "Show frequency polygon", TRUE) ,
  # checkboxInput("show_ash", "Show ASH plot", TRUE) 
