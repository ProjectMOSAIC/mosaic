...
The goal of this document is to demonstate how to calculate the quantities described in Chapter 2: Inference Using \emph{t}-Distributions using R.
...
This matches the results in  Display 2.2 (page 30 of the \emph{Sleuth}).
