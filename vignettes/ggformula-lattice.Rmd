...
```{r, message=FALSE}
xyplot(cesd ~ age, groups=sex, type=c("p", "r"), 
       auto.key=TRUE, data=HELPrct)
```
...
```{r, message=FALSE}
xyplot(cesd ~ age | sex, type=c("p", "smooth"), 
       auto.key=TRUE, data=HELPrct)
```
