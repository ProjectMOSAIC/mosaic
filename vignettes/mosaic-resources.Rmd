...
[github.com/ProjectMOSAIC/LittleBooks](https://github.com/ProjectMOSAIC/LittleBooks).
...
but much of the code originally in the `fastR` package has been moved into the `mosaic` package.
    ...
    * [http://www.ams.org/publications/authors/books/postpub/amstext-13](http://www.ams.org/publications/authors/books/postpub/amstext-13)
 ...
 * *Introduction to the Practice of Statistics in R* (NJ Horton)
 ...
 * *Statistics: Unlocking the Power of Data* (Lock, Lock, Lock, Lock, and Lock) 
    ...
    * [github.com/rpruim/Lock5withR/raw/master/Lock5withR.pdf](https://github.com/rpruim/Lock5withR/raw/master/Lock5withR.pdf)
    
    and the `Lock5withR` R package provides all the data sets used in the text.

 * *Introcution to Statistical Investigations* (Tintle *et al*) 
    ...
    * [github.com/rpruim/Tintle1/raw/master/Book/Tintle1.pdf](https://github.com/rpruim/Tintle1/raw/master/Book/Tintle1.pdf)
