...
The `ggformula` package includes a vignette comparing the lattice and ggformula formula interface to graphics: https://cran.r-project.org/package=ggformula/vignettes/ggformula-lattice.pdf
