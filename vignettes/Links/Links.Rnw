...
XX worth adding a plug for them here?

\section{Textbook Related}
\begin{description}
	\item[The Statistical Sleuth in R] \url{http://www.math.smith.edu/~nhorton/sleuth3}
These files are intended to help describe how to undertake analyses in R for the examples in the first 13 chapters of the Second Edition of the \emph{Statistical Sleuth: A Course in Methods of Data Analysis} (2002), the excellent text by Fred Ramsey and Dan Schafer.
	\item[Introduction to the Practice of Statistics in R] \url{http://www.math.smith.edu/~nhorton/ips6e}
These files describe how to undertake analyses in R that are introduced as examples in the first chapters of the Sixth Edition of \emph{Introduction to the Practice of Statistics} (2007), the excellent text by David Moore, George McCabe and Bruce Craig.
	\item[Statistics: Unlocking the Power of Data (Lock 5)] XX
\end{description}

\section{Books}
\begin{itemize}
\item D.T. Kaplan, {\em Statistical Modeling: A Fresh Approach}, 2nd edition, \url{http://www.mosaic-web.org/StatisticalModeling}.
\item R. Pruim, {\em Foundations and Applications of Statistics: An Introduction Using R}, 
