...
vignettes 
([*Resources Related to the mosaic package*](https://github.com/ProjectMOSAIC/mosaic/blob/beta/vignettes/mosaic-resources.Rmd)) includes a list of many resources, both within the
