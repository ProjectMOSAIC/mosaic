...
Once students have access to R, the \CRANpkg{mosaic} packages reduces, but does not eliminate,
...
For a course intended purely to provide statistical literacy, other options that 


## Better bootstrap confidence intervals

One improvement on to the "t with bootstrap standard error" interval is the bootstrap-t interval.
