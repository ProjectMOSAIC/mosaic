...
The formula template emphasizes that functions in R are typically named after the 
object they produce (the goal) and that a wide variety of goals can be achieved using a 
single template.  
```{r, results = "hide"}
...
the \CRANpkg{mosaic} package is attached.
