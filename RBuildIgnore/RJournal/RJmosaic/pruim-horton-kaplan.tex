...
While these generate similar output to the \texttt{mosaic} aggregation
...
than from raw data. The \pkg{mosaic} package masks these functions to
...
smaller set of objects. The \pkg{mosaic} package defines several
...
\begin{center}\includegraphics[width=.45\textwidth]{pruim-horton-kaplan_files/figure-latex/unnamed-chunk-33-1} \includegraphics[width=.45\textwidth]{pruim-horton-kaplan_files/figure-latex/unnamed-chunk-33-2} \includegraphics[width=.45\textwidth]{pruim-horton-kaplan_files/figure-latex/unnamed-chunk-33-3} \includegraphics[width=.45\textwidth]{pruim-horton-kaplan_files/figure-latex/unnamed-chunk-33-4} \end{center}
...
\begin{center}\includegraphics[width=.45\textwidth]{pruim-horton-kaplan_files/figure-latex/unnamed-chunk-40-1} \end{center}

\end{Schunk}

\noindent
Readers familiar with \pkg{lattice} will notice that the \pkg{mosaic}
package adds some additional arguments to the \texttt{histogram()}
function. Among these are \code{width} and \code{center} which can be
used to control the width and position of the bins and are much easier
for new users to master than the \code{breaks} argument supplied by
\pkg{lattice}.
...
One of the package vignettes \citep{mosaic-resources:2016} contains a
list of \pkg{mosaic}-related resources. Included in the list are links
to companion volumes for several textbooks, including two
simulation-based texts, \citep{Lock5,Tintle:2016}. Each of these
companion volumes demonstrates how to use R and the \pkg{mosaic} package
...
\begin{center}\includegraphics[width=.45\textwidth]{pruim-horton-kaplan_files/figure-latex/unnamed-chunk-61-1} \includegraphics[width=.45\textwidth]{pruim-horton-kaplan_files/figure-latex/unnamed-chunk-61-2} \end{center}
...
\begin{center}\includegraphics[width=.45\textwidth]{pruim-horton-kaplan_files/figure-latex/unnamed-chunk-62-1} \end{center}
...
encourage its use along side \pkg{mosaic}. Unfortunately, there are
...
Similarly, using \texttt{do()} comes at a price, although here the
...
\pkg{mosaic} package who have provided feedback on their experience and
...
Daniel T Kaplan\\
Macalester College\\
Department of Mathematics and Computer Science\\ 1600 Grand Avenue\\ St.~Paul, MN 55105 USA\\
}
